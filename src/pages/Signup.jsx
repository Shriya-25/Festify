  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden -z-10">
        <div className="absolute bottom-[20%] left-[10%] w-[50%] h-[50%] bg-primary/20 rounded-full blur-[120px] animate-float"></div>
        <div className="absolute top-[20%] right-[10%] w-[50%] h-[50%] bg-accent/20 rounded-full blur-[120px] animate-float" style={{ animationDelay: '-2s' }}></div>
      </div>
          ...
          <div className="space-y-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-5 animate-fade-in" style={{ animationDelay: '0.2s' }}>
              ...
              >
                ...
                <span className="font-medium">{googleLoading ? 'Sign up with Google' : 'Sign up with Google'}</span>
              </button>
